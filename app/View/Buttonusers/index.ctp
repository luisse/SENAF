...
<div class="panel-body">
	...
	foreach ($buttonusers as $buttonuser):
		?>
	<tr>
		<td><?php echo $buttonuser['Buttonuser']['id']; ?>&nbsp;</td>
		<td><?php echo $buttonuser['Buttonuser']['group_id']; ?>&nbsp;</td>
		<td><div class="btn-group"><a class='btn btn-app'><?php echo $buttonuser['Buttonuser']['buttondescr']; ?>&nbsp;</a></div></td>
		<td><?php echo $buttonuser['Buttonuser']['modelname']; ?>&nbsp;</td>
		<td><?php echo $buttonuser['Buttonuser']['actionname']; ?>&nbsp;</td>
		<td class="actions">
		<div class="btn-group">
	...
	<div class="col-lg-3">
		...
		<?php
			echo $this->Html->link('<button type="button" class="btn btn-success btn-lw" title="Agregar Categoria">
																	<span class="glyphicon  glyphicon-plus"></span>Nuevo Botón</button>',array('controller'=>'buttonusers',
										'action'=>'add',''),
										array('escape'=>false),
					'');		
		?>		
		...
		<center>
			<?php
				echo $this->Html->link('<button type="button" class="btn btn-success btn-lw" title="Agregar Boton Grupo">
																		<span class="glyphicon  glyphicon-plus"></span>Asociar Grupo</button>',array('controller'=>'buttonusers',
