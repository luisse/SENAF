...
<div class="panel panel-transacciones">
	<div class="panel-heading">
		<i class="fa fa-list fa-lg"></i>&nbsp;<?php echo __('Afinidades')?>    </div>
	<br>
...
<div class="panel-body">
	...
	<thead>
		<tr>
					...
					<th><?php echo $this->Paginator->sort('definicion',__('Detalle'));?></th>
					<th width='90px'><?php __('Acciones');?></th>
		</tr>
	</thead>
	<tbody>
	<?php
	foreach ($afinidades as $afinidade):
		?>
	<tr>
		<td><?php echo $afinidade['Afinidade']['descrip']; ?>&nbsp;</td>
		<td><?php echo $afinidade['Afinidade']['definicion']; ?>&nbsp;</td>
		<td class="actions">
		<div class="btn-group">
			<a class="btn btn-primary" href="#"><i class="fa fa-plus-circle fa-fw"></i> </a>
				<a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#">
					...
					<li>
							<?php 
							echo $this->Html->link('<i class="fa fa-edit fa-fw"></i>&nbsp;'.__('Modificar'),array('controller'=>'afinidades',
								'action'=>'edit',$afinidade['Afinidade']['id']),
								array('onclick'=>'','escape'=>false),
								'');?>
					</li>
						<li>
										<?php echo $this->Html->link('<i class="fa fa-trash-o fa-fw"></i>&nbsp;'.__('Borrar'),array('controller'=>'afinidades',
											'action'=>'delete',$afinidade['Afinidade']['id']),
	...
	<div class="col-xs-6 col-sm-6">
		...
		<?php
			echo $this->Html->link('<button type="button" class="btn btn-success btn-lw" title="Agregar Categoria">
																	<span class="glyphicon  glyphicon-plus"></span>Agregar</button>',array('controller'=>'afinidades',
										'action'=>'add',''),
										array('escape'=>false),
					'');		
	?>		</center>
