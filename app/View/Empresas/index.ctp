...
<div class="panel panel-transacciones">
	<div class="panel-heading">
		<i class="fa fa-list fa-lg"></i>&nbsp;<?php echo __('Empresas')?>    </div>
	<br>
...
<div class="panel-body">
	...
	<thead>
		<tr>
					...
					<th><?php echo $this->Paginator->sort('tipoempresa_id');?></th>
	...
	<tr>
		...
		<td><?php echo $empresa['Empresa']['tipoempresa_id']; ?>&nbsp;</td>
		<td><?php echo $empresa['Empresa']['denominacion']; ?>&nbsp;</td>
		...
		<div class="btn-group">
			<a class="btn btn-primary" href="#"><i class="fa fa-plus-circle fa-fw"></i> </a>
				<a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#">
					...
					<li>
							<?php 
							echo $this->Html->link('<i class="fa fa-edit fa-fw"></i>&nbsp;'.__('Modificar'),array('controller'=>'empresas',
								'action'=>'edit',$empresa['empresa']['id']),
								array('onclick'=>'','escape'=>false),
								'');?>
					</li>
						<li>
										<?php echo $this->Html->link('<i class="fa fa-trash-o fa-fw"></i>&nbsp;'.__('Borrar'),array('controller'=>'empresas',
											'action'=>'delete',$empresa['empresa']['id']),
	...
	<div class="col-lg-6">
		...
		<?php
			echo $this->Html->link('<button type="button" class="btn btn-success btn-lw" title="Agregar Categoria">
																	<span class="glyphicon  glyphicon-plus"></span>Agregar</button>',array('controller'=>'empresas',
										'action'=>'add',''),
										array('escape'=>false),
					'');		
	?>		</center>
