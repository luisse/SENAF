<?php echo $this->Html->script(array('/js/persxgrupsociales/add.js','fmensajes.js','fgenerales.js','jquery.toastmessage','jquery.numeric'),array('block'=>'scriptjs')); ?>
<?php echo $this->Html->css('message', null, array('inline' => false))?>
<?php echo $this->element('flash_message')?>
<?php echo $this->Form->create('Persxgrupsociale',array('action'=>'add',	
				'inputDefaults' => array(
							'div' => 'form-group',
							'wrapInput' => false,
							'class' => 'form-control'
...
<fieldset>
	<legend>		<?php echo __('Asociar Persona a Grupo Social') ?></legend>
		
			<div class="row">
				<div class="col-lg-10">
					<h3><span class="label label-success"><?php echo $gruposociale['Grupsociale']['id'].'-'.$gruposociale['Afinidade']['descrip']?></span></h3>
				</div>
			</div>
...
<!-- TABLA DE DETALLE -->
		<div class="table-responsive">
			...
			<div class="tab-pane active"  id="tabs-1">
				...
				<table cellspacing="1" width='80%'  class="table table-striped table-bordered table-hover dataTable no-footer" aria-describedby="dataTables-example_info" id = "persxoficinas">
				<thead>
					<tr>
							<th></th>
				...
				<tbody>
					...
					<?php echo "<tr id='persxoficina_".$i."'>"?>
							...
							<td><?php echo $this->Form->input('Persxgruposociale.'.$i.'.persona_id',array('label' => false	,
																	'class'=>'form-control input-sm id',
																	'type'=>'text',
																	'length'=>'5',
																	'error'=>array('attributes' =>array('class'=>'alert alert-danger'))))?></td>
							<td><?php echo $this->Form->input('Persxgruposociale.'.$i.'.documento',array('label' => false	,
																	'class'=>'form-control input-sm detail documento',
																	'type'=>'text',
																	'maxlength'=>'13',
																	'error'=>array('attributes' =>array('class'=>'alert alert-danger'))))?></td>
																	
							<td><?php echo $this->Form->input('Persxgruposociale.'.$i.'.nombreapellido',array('label' => false	,
