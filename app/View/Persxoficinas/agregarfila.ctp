...
<td><?php echo $this->Form->input('Persxoficina.'.$row.'.persona_id',array('label' => false	,
															'class'=>'form-control input-sm id',
															'type'=>'text',
															'length'=>'5',
															'error'=>array('attributes' =>array('class'=>'alert alert-danger'))))?></td>
<td><?php echo $this->Form->input('Persxoficina.'.$row.'.documento',array('label' => false	,
															'class'=>'form-control input-sm detail',
															'type'=>'text',
															'maxlength'=>'50',
															'error'=>array('attributes' =>array('class'=>'alert alert-danger'))))?></td>
																	
<td><?php echo $this->Form->input('Persxoficina.'.$row.'.nombreapellido',array('label' => false	,
																	'class'=>'form-control input-sm detail',
																	'type'=>'text',
																	'maxlength'=>'50',
																	'error'=>array('attributes' =>array('class'=>'alert alert-danger'))))?></td>
