...
<div class="panel panel-transacciones">
	<div class="panel-heading">
		<i class="fa fa-list fa-lg"></i>&nbsp;<?php echo __('Persxoficinas')?>    </div>
	<br>
...
<div class="panel-body">
	...
	foreach ($persxoficinas as $persxoficina):
		?>
	<tr>
		<td><?php echo $persxoficina['Persxoficina']['id']; ?>&nbsp;</td>
		<td><?php echo $persxoficina['Persxoficina']['persona_id']; ?>&nbsp;</td>
		<td><?php echo $persxoficina['Persxoficina']['oficina_id']; ?>&nbsp;</td>
		<td><?php echo $persxoficina['Persxoficina']['activo']; ?>&nbsp;</td>
		<td><?php echo $persxoficina['Persxoficina']['fechabaja']; ?>&nbsp;</td>
		<td class="actions">
		<div class="btn-group">
