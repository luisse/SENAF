<?php echo $this->Html->script(array('/js/users/addusuario.js','jquery.maskedinput','bootstrap-datetimepicker','fmensajes.js','fgenerales.js','jquery.numeric'),array('block'=>'scriptjs'));		?>
