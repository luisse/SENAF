<?php	echo $this->Html->script(array('/js/users/edit.js','jquery.toastmessage'),array('block'=>'scriptjs'));?>
...
<div class="tab-pane  active" id="tabs-1">
	...
	<fieldset>
					...
					<div class="col-lg-12">		
						<div class="alert alert-warning" >
										<?php if($this->Session->read('tipousr') != 2):?>	
											<?php echo $this->Html->link($this->Html->image('edit.gif',array('title'=>__('Editar Datos Personales',true))),array('controller'=>'clientes',
		...
		<div class="row">	
			<div class="col-lg-3">
				<?php echo $this->Form->input('Cliente.documento',array('label' => 'Nro de Documento',
...
<div id="tabs-2" class="tab-pane">
	...
	<fieldset>
		<div class='row'>
			<div class='col-lg-5'>
					<?php echo $this->Form->input('imgcliente',array('label'=>'Foto del Cliente',
			 ...
			 <div class="col-xs-6 col-md-3">
				<a href="#" class="thumbnail">
					<?php  echo $this->Html->image(array ( 'controller' =>
									...
									$clientes['Cliente']['id']),
									array ( 'title' =>'Imagen del Cliente') );
							?>
				</a>
			</div>
		</div>
	...
	<div class="row">	
		<div class="col-lg-1">
			...
			<button type="button" class="btn btn-success btn-lw" id='actualizarfoto'>
			  <span class="glyphicon glyphicon glyphicon-save"></span> Actualizar Foto
			</button>	
			</center>
		</div>
	</div>
