...
<fieldset>
	...
	<div class="row">	
		<div class="col-lg-4">
			...
			<?php echo $this->Form->input('domicilio',array('label'=>'Domiclio',
		...
		<div class="col-lg-2">
			<?php echo $this->Form->input('dpto',array('label'=>'Dpto',
		...
		<div class="col-lg-2">
		<?php echo $this->Form->input('piso',array('label'=>'Piso',
														'placeholder' => 'Piso',
														'size'=>'2',
														'class'=>'form-control input-sm',
														'error'=>array('attributes' =>array('class'=>'alert alert-danger'))))?>
		...
		<div class="col-lg-2">																																																
		<?php echo $this->Form->input('block',array('label'=>'Block',
														'placeholder' => 'Block',
														'size'=>'2',
														'class'=>'form-control input-sm',
														'error'=>array('attributes' =>array('class'=>'alert alert-danger'))))?>
