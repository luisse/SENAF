...
<div class="panel panel-transacciones">
	<div class="panel-heading">
		<i class="fa fa-list fa-lg"></i>&nbsp;<?php echo __('Calles')?>    </div>
	<br>
...
<div class="panel-body">
	...
	foreach ($calles as $calle):
		?>
	<tr>
		<td><?php echo $calle['Calle']['id']; ?>&nbsp;</td>
		<td><?php echo $calle['Calle']['descrip']; ?>&nbsp;</td>
		<td><?php echo $calle['Calle']['usuariocrea']; ?>&nbsp;</td>
		<td><?php echo $calle['Calle']['ipcrea']; ?>&nbsp;</td>
		<td><?php echo $calle['Calle']['created']; ?>&nbsp;</td>
		<td><?php echo $calle['Calle']['usuarioactu']; ?>&nbsp;</td>
		<td><?php echo $calle['Calle']['ipactu']; ?>&nbsp;</td>
		<td><?php echo $calle['Calle']['modified']; ?>&nbsp;</td>
		<td class="actions">
		<div class="btn-group">
			<a class="btn btn-primary" href="#"><i class="fa fa-plus-circle fa-fw"></i> </a>
				<a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#">
					...
					<li>
							<?php 
							echo $this->Html->link('<i class="fa fa-edit fa-fw"></i>&nbsp;'.__('Modificar'),array('controller'=>'calles',
								'action'=>'edit',$calle['calle']['id']),
								array('onclick'=>'','escape'=>false),
								'');?>
					</li>
						<li>
										<?php echo $this->Html->link('<i class="fa fa-trash-o fa-fw"></i>&nbsp;'.__('Borrar'),array('controller'=>'calles',
											'action'=>'delete',$calle['calle']['id']),
	...
	<div class="col-lg-6">
		...
		<?php
			echo $this->Html->link('<button type="button" class="btn btn-success btn-lw" title="Agregar Categoria">
																	<span class="glyphicon  glyphicon-plus"></span>Agregar</button>',array('controller'=>'calles',
										'action'=>'add',''),
										array('escape'=>false),
					'');		
	?>		</center>
