		<?php echo $this->Html->script(array('/js/estciviles/add.js','fmensajes.js','fgenerales.js','jquery.toastmessage'),array('block'=>'scriptjs')); ?>
...
<fieldset>
	<legend>		
		<?php echo __('Nuevo Estado Civil') ?></legend>
			<div class="row">
				<div class="col-lg-6">
