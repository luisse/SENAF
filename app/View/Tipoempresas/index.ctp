...
<div class="panel panel-transacciones">
	<div class="panel-heading">
		<i class="fa fa-list fa-lg"></i>&nbsp;<?php echo __('Tipoempresas')?>    </div>
	<br>
...
<div class="panel-body">
	...
	foreach ($tipoempresas as $tipoempresa):
		?>
	<tr>
		<td><?php echo $tipoempresa['Tipoempresa']['id']; ?>&nbsp;</td>
		<td><?php echo $tipoempresa['Tipoempresa']['descrip']; ?>&nbsp;</td>
		<td class="actions">
		<div class="btn-group">
			<a class="btn btn-primary" href="#"><i class="fa fa-plus-circle fa-fw"></i> </a>
				<a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#">
					...
					<li>
							<?php 
							echo $this->Html->link('<i class="fa fa-edit fa-fw"></i>&nbsp;'.__('Modificar'),array('controller'=>'tipoempresas',
								'action'=>'edit',$tipoempresa['tipoempresa']['id']),
								array('onclick'=>'','escape'=>false),
								'');?>
					</li>
						<li>
										<?php echo $this->Html->link('<i class="fa fa-trash-o fa-fw"></i>&nbsp;'.__('Borrar'),array('controller'=>'tipoempresas',
											'action'=>'delete',$tipoempresa['tipoempresa']['id']),
	...
	<div class="col-lg-6">
		...
		<?php
			echo $this->Html->link('<button type="button" class="btn btn-success btn-lw" title="Agregar Categoria">
																	<span class="glyphicon  glyphicon-plus"></span>Agregar</button>',array('controller'=>'tipoempresas',
										'action'=>'add',''),
										array('escape'=>false),
					'');		
	?>		</center>
